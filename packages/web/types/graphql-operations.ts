...
} as unknown as DocumentNode<RequestMutation, RequestMutationVariables>
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'UserSignInInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'data' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'UserAuthInput' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
export const CountdownDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'Countdown' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            name: { kind: 'Name', value: 'countdown' },
            arguments: [
              { kind: 'Argument', name: { kind: 'Name', value: 'from' }, value: { kind: 'IntValue', value: '10' } },
            ],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'Field', name: { kind: 'Name', value: 'value' } }],
...
} as unknown as DocumentNode<CountdownSubscription, CountdownSubscriptionVariables>
...
} as unknown as DocumentNode<RandomSubscription, RandomSubscriptionVariables>
...
} as unknown as DocumentNode<RequestsSubscription, RequestsSubscriptionVariables>
